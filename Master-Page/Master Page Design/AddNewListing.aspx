<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddNewListing.aspx.cs" Inherits="Master_Page_Design.AddNewListing" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2 style="margin-left: 35%">Adding New Job Listing</h2>
        ...
        <tr>
            <td>
                <div class="ProgressBar">
                    ...
                    <asp:Button ID="BasicLink" class="ButtonLink" runat="server" Text="1" OnClick="BasicLink_Click" />
                    <%--<a href="#AdvanceInfo" class="ProgessColor">Experience, Salary, Overview</a>--%>
                    <asp:Button ID="AdvanceLink" class="ButtonLink" runat="server" Text="2" OnClick="AdvanceLink_Click" />
                    <%--<a href="#AdvanceInfo" class="ProgessColor">Resposibilities</a>--%>
                    <asp:Button ID="ResponsibilitiesLink" class="ButtonLink" runat="server" Text="3" OnClick="ResponsibilitiesLink_Click" />
                    <%--<a href="#AdvanceInfo" class="ProgessColor">Requirements</a>--%>
                    <asp:Button ID="RequirementLink" class="ButtonLink" runat="server" Text="4" OnClick="RequirementLink_Click" />
                    <%--<a href="#AdvanceInfo" class="ProgessColor">Job level, Qualifications, Categories, Listing Expiry Date</a>--%>
                    <asp:Button ID="FinalLink" class="ButtonLink" runat="server" Text="5" OnClick="FinalLink_Click" />
                </div>
            </td>
        </tr>
        <tr class="InputRow">
            <td>
                ...
                <asp:Panel class="ListingBox" id="FinalInfoBox" runat="server" Visible="False">
                    ...
                    <br />
                    <asp:Button ID="AddBtn" runat="server" Text="Add Job" OnClick="AddBtn_Click" />
                    <br />
